...
print(page.content())
    """
    bs1 = BrowserSimulator(f'{HONEST_RP_ENDPOINT}/login?issuer={HONEST_OP_ENDPOINT}/', PROXY_SERVER_ENDPOINT)
    bs1.run(sso_flow)
    bs1.close()
...
print(page.content())
    """
    bs2 = BrowserSimulator(f'{HONEST_RP_ENDPOINT}/login?issuer={HONEST_OP_ENDPOINT}/', PROXY_SERVER_ENDPOINT)
    bs2.run(sso_flow)
